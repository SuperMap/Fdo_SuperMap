...
[!output PREFIX]LockOwnersReader::[!output PREFIX]LockOwnersReader ()
{
}

[!output PREFIX]LockOwnersReader::~[!output PREFIX]LockOwnersReader (void)
{
}

// <summary>Dispose this object.</summary>
// <returns>Returns nothing</returns> 
void [!output PREFIX]LockOwnersReader::Dispose ()
{
    delete this;
}
...
FdoString* [!output PREFIX]LockOwnersReader::GetLockOwner ()
{
    return (L"");
}
...
bool [!output PREFIX]LockOwnersReader::ReadNext ()
{
    return (false);
}
...
/// holding.</summary>
/// <returns>Returns nothing</returns> 
void [!output PREFIX]LockOwnersReader::Close ()
{
}
