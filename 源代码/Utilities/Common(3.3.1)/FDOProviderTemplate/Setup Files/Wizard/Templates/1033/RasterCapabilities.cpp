...
[!output PREFIX]RasterCapabilities::[!output PREFIX]RasterCapabilities ()
{
}
...
void [!output PREFIX]RasterCapabilities::Dispose()
{
    delete this;
}
...
bool [!output PREFIX]RasterCapabilities::SupportsRaster ()
{
    return (false);
}
...
bool [!output PREFIX]RasterCapabilities::SupportsStitching ()
{
    return (false);
}
...
bool [!output PREFIX]RasterCapabilities::SupportsSubsampling ()
{
    return (false);
}
...
bool [!output PREFIX]RasterCapabilities::SupportsDataModel (FdoRasterDataModel* model)
{
    return (false);
}
