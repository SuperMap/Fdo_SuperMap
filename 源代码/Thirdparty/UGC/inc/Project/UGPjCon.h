#ifndef _PROJCONSTANTS_H
#define _PROJCONSTANTS_H
...
/*----------------------------------------------------------------------------*/
const UGint PRJ_METHOD_COUNT = 41;
...
//{
#define PJPARAM_FALSE_EASTING	"X0"		//  0 False easting (X0)
#define PJPARAM_FALSE_NORTHING	"Y0"		//  1 False northing (Y0)
							
#define PJPARAM_CENTRAL_LON	"LON0"	//  2 Central meridian, Longitude of origin (LON0)
#define PJPARAM_LAT0	"LAT0"	//  3 Central parallel, Latitude of origin	(LAT0)
#define PJPARAM_LAT1	"LAT1"	//  4 Standard parallel 1, Latitude of 1st point (LAT1)
#define PJPARAM_LAT2	"LAT2"	//  5 Standard parallel 2, Latitude of 2nd point (LAT2)
#define PJPARAM_SCALEFACTOR "ScaleFactor"	//  6 Scale factor
#define PJPARAM_AZIMUTH "Azimuth"			//  7 Azimuth

#define PJPARAM_LON1    "LON1"	//  8 Longitude of 1st point (LON1)
#define PJPARAM_LON2    "LON2"	//  9 Longitude of 2nd point  (LON2)
