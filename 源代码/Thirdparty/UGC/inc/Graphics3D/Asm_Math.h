#ifndef UG_ASM_MATH_H_
#define UG_ASM_MATH_H_

//这个头文件是从OGRE里拿来的
//Thanks to the authors of Ogre

#include <math.h>  // added by Y.M.Zheng 
/*=============================================================================
...
//#pragma message( "asm_sin-->COMPILER_MSVC" )
