...
namespace UGC
{
	class GRAPHICS3D_API UGMatrix3  
	{
	private:
	...
	public:
		...
		UGbool   ToEulerAnglesXYZ ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
		UGbool   ToEulerAnglesXZY ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
		UGbool   ToEulerAnglesYXZ ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
		UGbool   ToEulerAnglesYZX ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
		UGbool   ToEulerAnglesZXY ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
		UGbool   ToEulerAnglesZYX ( Real& rfYAngle, Real& rfPAngle, Real& rfRAngle ) const;
