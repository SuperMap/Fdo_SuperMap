...
#if !defined(AFX_UGRENDERABLE_H__618529B0_589C_4A7C_BFEF_C57EF5C363A8__INCLUDED_)
#define AFX_UGRENDERABLE_H__618529B0_589C_4A7C_BFEF_C57EF5C363A8__INCLUDED_
...
public:
	...
	UGRenderable();
	//! \brief 析构函数
	virtual ~UGRenderable();

public:
	
	
	//! \brief 构造函数
	UGRenderable(const UGString& strName);
	//! \brief 设置可渲染对象的名称标志
	// 名称只有UGMovableObject才拥有该属性
	// 这里参考OGRE设置方法去除Renderable中Name属性
	void SetRenderableName(const UGString& strName);
	//! \brief 获得可渲染对象的名称标志
	UGString GetRenderableName();
	//! \brief 设置可渲染对象是否可见
...
#endif // !defined(AFX_UGRENDERABLE_H__618529B0_589C_4A7C_BFEF_C57EF5C363A8__INCLUDED_)
