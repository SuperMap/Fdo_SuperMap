...
//
// MessageId: SCHEMA_149_CONSTRAINTDATAVIOLATION
//
// MessageText:
//
//  Cannot modify constraint for property '%1$ls'; existing data value '%2$ls' violates new constraint
//
#define SCHEMA_149_CONSTRAINTDATAVIOLATION 0x0000047DL
...
//
// MessageId: FUNCTION_GENERAL_ARG
//
// MessageText:
//
//  Argument to be processed
//
#define FUNCTION_GENERAL_ARG             0x00001F5DL

//
// MessageId: FUNCTION_OPERATOR_ARG
//
// MessageText:
//
//  Operation indicator (ALL or DISTINCT)
//
#define FUNCTION_OPERATOR_ARG            0x00001F5EL

//
// MessageId: FUNCTION_OPERATOR_ARG_LIT
//
// MessageText:
//
//  Operation Indicator
//
#define FUNCTION_OPERATOR_ARG_LIT        0x00001F5FL

//
// MessageId: FUNCTION_BYTE_ARG_LIT
//
// MessageText:
//
//  byte
//
#define FUNCTION_BYTE_ARG_LIT            0x00001F60L

//
// MessageId: FUNCTION_DATE_ARG_LIT
//
// MessageText:
//
//  date/time
//
#define FUNCTION_DATE_ARG_LIT            0x00001F61L

//
// MessageId: FUNCTION_NUMBER_ARG_LIT
//
// MessageText:
//
//  number
//
#define FUNCTION_NUMBER_ARG_LIT          0x00001F62L

//
// MessageId: FUNCTION_STRING_ARG_LIT
//
// MessageText:
//
//  text property
//
#define FUNCTION_STRING_ARG_LIT          0x00001F63L

//
// MessageId: FUNCTION_PARAMETER_NUMBER_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid number of parameters for function '%1$ls'
//
#define FUNCTION_PARAMETER_NUMBER_ERROR  0x00001F64L

//
// MessageId: FUNCTION_PARAMETER_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid parameters for function '%1$ls'
//
#define FUNCTION_PARAMETER_ERROR         0x00001F65L

//
// MessageId: FUNCTION_PARAMETER_DATA_TYPE_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid parameter data type for function '%1$ls'
//
#define FUNCTION_PARAMETER_DATA_TYPE_ERROR 0x00001F66L

//
// MessageId: FUNCTION_RESULT_DATA_TYPE_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid data type for return value for function '%1$ls'
//
#define FUNCTION_RESULT_DATA_TYPE_ERROR  0x00001F67L

//
// MessageId: FUNCTION_OPERATOR_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid operator parameter value for function '%1$ls'
//
#define FUNCTION_OPERATOR_ERROR          0x00001F68L

//
// MessageId: FUNCTION_BOOL_ARG_LIT
//
// MessageText:
//
//  boolean
//
#define FUNCTION_BOOL_ARG_LIT            0x00001F69L

//
// MessageId: FUNCTION_BLOB_ARG_LIT
//
// MessageText:
//
//  blob
//
#define FUNCTION_BLOB_ARG_LIT            0x00001F6AL

//
// MessageId: FUNCTION_CLOB_ARG_LIT
//
// MessageText:
//
//  clob
//
#define FUNCTION_CLOB_ARG_LIT            0x00001F6BL

//
// MessageId: FUNCTION_PARAMETER_DISTINCT_ERROR
//
// MessageText:
//
//  Expression Engine: DISTINCT not allowed for BLOB/CLOB for function '%1$ls'
//
#define FUNCTION_PARAMETER_DISTINCT_ERROR 0x00001F6CL

//
// MessageId: FUNCTION_SIGN
//
// MessageText:
//
//  Returns -1, 0, 1 depending on whether the value is < 0, == 0 or > 0
//
#define FUNCTION_SIGN                    0x00001F6DL

//
// MessageId: FUNCTION_CONCAT_STRING1_ARG
//
// MessageText:
//
//  First string to concatenate
//
#define FUNCTION_CONCAT_STRING1_ARG      0x00001F6EL

//
// MessageId: FUNCTION_CONCAT_STRING2_ARG
//
// MessageText:
//
//  Second string to concatenate
//
#define FUNCTION_CONCAT_STRING2_ARG      0x00001F6FL

//
// MessageId: FUNCTION_UPPER_STRING_ARG
//
// MessageText:
//
//  String to be converted into uppercase
//
#define FUNCTION_UPPER_STRING_ARG        0x00001F70L

//
// MessageId: FUNCTION_LOWER_STRING_ARG
//
// MessageText:
//
//  String to be converted into lowercase
//
#define FUNCTION_LOWER_STRING_ARG        0x00001F71L

//
// MessageId: FUNCTION_GEOM_ARG_LIT
//
// MessageText:
//
//  geometry property
//
#define FUNCTION_GEOM_ARG_LIT            0x00001F72L

//
// MessageId: FUNCTION_ABS
//
// MessageText:
//
//  Determines the absolute value of a numeric expression
//
#define FUNCTION_ABS                     0x00001F73L

//
// MessageId: FUNCTION_ACOS
//
// MessageText:
//
//  Determines the arc cosine of a numeric expression
//
#define FUNCTION_ACOS                    0x00001F74L

//
// MessageId: FUNCTION_ASIN
//
// MessageText:
//
//  Determines the arc sine of a numeric expression
//
#define FUNCTION_ASIN                    0x00001F75L

//
// MessageId: FUNCTION_ATAN
//
// MessageText:
//
//  Determines the arc tangent of a numeric expression
//
#define FUNCTION_ATAN                    0x00001F76L

//
// MessageId: FUNCTION_COS
//
// MessageText:
//
//  Determines the cosine of a numeric expression
//
#define FUNCTION_COS                     0x00001F77L

//
// MessageId: FUNCTION_EXP
//
// MessageText:
//
//  Determines e raised to the power of a numeric expression value
//
#define FUNCTION_EXP                     0x00001F78L

//
// MessageId: FUNCTION_LN
//
// MessageText:
//
//  Determines the natural logarithm of a numeric expression
//
#define FUNCTION_LN                      0x00001F79L

//
// MessageId: FUNCTION_SIN
//
// MessageText:
//
//  Determines the sine of a numeric expression
//
#define FUNCTION_SIN                     0x00001F7AL

//
// MessageId: FUNCTION_SQRT
//
// MessageText:
//
//  Determines the square root of a numeric expression
//
#define FUNCTION_SQRT                    0x00001F7BL

//
// MessageId: FUNCTION_TAN
//
// MessageText:
//
//  Determines the tangent of a numeric expression
//
#define FUNCTION_TAN                     0x00001F7CL

//
// MessageId: FUNCTION_ATAN2
//
// MessageText:
//
//  Determines the arc tangent of two numeric expressions
//
#define FUNCTION_ATAN2                   0x00001F7DL

//
// MessageId: FUNCTION_LOG_BASE_ARG
//
// MessageText:
//
//  Logarithm base value
//
#define FUNCTION_LOG_BASE_ARG            0x00001F7EL

//
// MessageId: FUNCTION_BASE_ARG_LIT
//
// MessageText:
//
//  base
//
#define FUNCTION_BASE_ARG_LIT            0x00001F7FL

//
// MessageId: FUNCTION_DIV_BY_0_ERROR
//
// MessageText:
//
//  Expression Engine: Attempt to divide by 0 ('%1$ls')
//
#define FUNCTION_DIV_BY_0_ERROR          0x00001F80L

//
// MessageId: FUNCTION_DIVISOR_ARG
//
// MessageText:
//
//  The divisor
//
#define FUNCTION_DIVISOR_ARG             0x00001F81L

//
// MessageId: FUNCTION_DIV_ARG_LIT
//
// MessageText:
//
//  divisor
//
#define FUNCTION_DIV_ARG_LIT             0x00001F82L

//
// MessageId: FUNCTION_MOD
//
// MessageText:
//
//  Determines the remainder of the division of two numeric expressions
//
#define FUNCTION_MOD                     0x00001F83L

//
// MessageId: FUNCTION_LOG
//
// MessageText:
//
//  Determines the logarithm of two numeric expressions
//
#define FUNCTION_LOG                     0x00001F84L

//
// MessageId: FUNCTION_REMAINDER
//
// MessageText:
//
//  Determines the remainder of the division of two numeric expressions
//
#define FUNCTION_REMAINDER               0x00001F85L

//
// MessageId: FUNCTION_POWER_ARG
//
// MessageText:
//
//  Represents the power value a number should be raised to
//
#define FUNCTION_POWER_ARG               0x00001F86L

//
// MessageId: FUNCTION_POWER
//
// MessageText:
//
//  Raises a numeric expression to the power of another numeric expression
//
#define FUNCTION_POWER                   0x00001F87L

//
// MessageId: FUNCTION_DATA_VALUE_ERROR
//
// MessageText:
//
//  Expression Engine: Invalid value for execution of function '%1$ls'
//
#define FUNCTION_DATA_VALUE_ERROR        0x00001F88L

//
// MessageId: FUNCTION_ROUND
//
// MessageText:
//
//  Rounds a numeric expressions to the specified degree
//
#define FUNCTION_ROUND                   0x00001F89L

//
// MessageId: FUNCTION_UNEXPECTED_RESULT_ERROR
//
// MessageText:
//
//  Expression Engine: Unexpected result for function '%1$ls'
//
#define FUNCTION_UNEXPECTED_RESULT_ERROR 0x00001F8AL

//
// MessageId: FUNCTION_ROUND_OPT_DECIMAL_ARG
//
// MessageText:
//
//  Represents an optional number of decimals to round to
//
#define FUNCTION_ROUND_OPT_DECIMAL_ARG   0x00001F8BL

//
// MessageId: FUNCTION_OPT_DECIMAL_ARG_LIT
//
// MessageText:
//
//  optional number of decimals
//
#define FUNCTION_OPT_DECIMAL_ARG_LIT     0x00001F8CL

//
// MessageId: FUNCTION_TRUNC
//
// MessageText:
//
//  Truncates a numeric or date expression as specified
//
#define FUNCTION_TRUNC                   0x00001F8DL

//
// MessageId: FUNCTION_TRUNC_OPT_DECIMAL_ARG
//
// MessageText:
//
//  Represents an optional number of decimals to truncate to
//
#define FUNCTION_TRUNC_OPT_DECIMAL_ARG   0x00001F8EL

//
// MessageId: FUNCTION_TRUNC_OPT_DATE_ARG
//
// MessageText:
//
//  Represents an indicator to what the date to truncate to
//
#define FUNCTION_TRUNC_OPT_DATE_ARG      0x00001F8FL

//
// MessageId: FUNCTION_TRUNC_DATE_OP_ARG
//
// MessageText:
//
//  Truncation indicator (YEAR, MONTH, DAY, HOUR, MINUTE)
//
#define FUNCTION_TRUNC_DATE_OP_ARG       0x00001F90L

//
// MessageId: FUNCTION_LENGTH_STRING_ARG
//
// MessageText:
//
//  String for which to calculate the length
//
#define FUNCTION_LENGTH_STRING_ARG       0x00001F91L

//
// MessageId: FUNCTION_LENGTH
//
// MessageText:
//
//  Determines the length of a string expression
//
#define FUNCTION_LENGTH                  0x00001F92L

//
// MessageId: FUNCTION_LPAD_STRING_ARG
//
// MessageText:
//
//  String to pad to the left
//
#define FUNCTION_LPAD_STRING_ARG         0x00001F93L

//
// MessageId: FUNCTION_PAD_LENGTH_ARG
//
// MessageText:
//
//  The length the string should be padded to
//
#define FUNCTION_PAD_LENGTH_ARG          0x00001F94L

//
// MessageId: FUNCTION_PAD_STRING_ARG
//
// MessageText:
//
//  The string to be used to pad
//
#define FUNCTION_PAD_STRING_ARG          0x00001F95L

//
// MessageId: FUNCTION_PAD_LENGTH_ARG_LIT
//
// MessageText:
//
//  number of characters
//
#define FUNCTION_PAD_LENGTH_ARG_LIT      0x00001F96L

//
// MessageId: FUNCTION_PAD_STRING_ARG_LIT
//
// MessageText:
//
//  pad string
//
#define FUNCTION_PAD_STRING_ARG_LIT      0x00001F97L

//
// MessageId: FUNCTION_LPAD
//
// MessageText:
//
//  Pads a string expression as directed to the left
//
#define FUNCTION_LPAD                    0x00001F98L

//
// MessageId: FUNCTION_RPAD_STRING_ARG
//
// MessageText:
//
//  String to pad to the right
//
#define FUNCTION_RPAD_STRING_ARG         0x00001F99L

//
// MessageId: FUNCTION_RPAD
//
// MessageText:
//
//  Pads a string expression as directed to the right
//
#define FUNCTION_RPAD                    0x00001F9AL

//
// MessageId: FUNCTION_LTRIM_STRING_ARG
//
// MessageText:
//
//  String to trim on the left
//
#define FUNCTION_LTRIM_STRING_ARG        0x00001F9BL

//
// MessageId: FUNCTION_LTRIM
//
// MessageText:
//
//  Trims a string expression on the left
//
#define FUNCTION_LTRIM                   0x00001F9CL

//
// MessageId: FUNCTION_RTRIM_STRING_ARG
//
// MessageText:
//
//  String to trim on the right
//
#define FUNCTION_RTRIM_STRING_ARG        0x00001F9DL

//
// MessageId: FUNCTION_RTRIM
//
// MessageText:
//
//  Trims a string expression on the right
//
#define FUNCTION_RTRIM                   0x00001F9EL

//
// MessageId: FUNCTION_INSTR_STRING1_ARG
//
// MessageText:
//
//  String to search in
//
#define FUNCTION_INSTR_STRING1_ARG       0x00001F9FL

//
// MessageId: FUNCTION_INSTR_STRING2_ARG
//
// MessageText:
//
//  String to look for
//
#define FUNCTION_INSTR_STRING2_ARG       0x00001FA0L

//
// MessageId: FUNCTION_STRING_SEARCH_ARG_LIT
//
// MessageText:
//
//  search text
//
#define FUNCTION_STRING_SEARCH_ARG_LIT   0x00001FA1L

//
// MessageId: FUNCTION_INSTR
//
// MessageText:
//
//  Returns the position of a string within a base string
//
#define FUNCTION_INSTR                   0x00001FA2L

//
// MessageId: FUNCTION_SUBSTR_STRING_ARG
//
// MessageText:
//
//  String from which to extract
//
#define FUNCTION_SUBSTR_STRING_ARG       0x00001FA3L

//
// MessageId: FUNCTION_SUBSTR_START_POS_ARG
//
// MessageText:
//
//  Position from which to extract a substring
//
#define FUNCTION_SUBSTR_START_POS_ARG    0x00001FA4L

//
// MessageId: FUNCTION_SUBSTR_LENGTH_ARG
//
// MessageText:
//
//  The length of the substring to extract
//
#define FUNCTION_SUBSTR_LENGTH_ARG       0x00001FA5L

//
// MessageId: FUNCTION_SUBSTR_START_POS_ARG_LIT
//
// MessageText:
//
//  position to start
//
#define FUNCTION_SUBSTR_START_POS_ARG_LIT 0x00001FA6L

//
// MessageId: FUNCTION_SUBSTR_LENGTH_ARG_LIT
//
// MessageText:
//
//  optional length of substring
//
#define FUNCTION_SUBSTR_LENGTH_ARG_LIT   0x00001FA7L

//
// MessageId: FUNCTION_SUBSTR
//
// MessageText:
//
//  Returns a substring from a provided string as defined
//
#define FUNCTION_SUBSTR                  0x00001FA8L

//
// MessageId: FUNCTION_TRIM_STRING_ARG
//
// MessageText:
//
//  String to trim
//
#define FUNCTION_TRIM_STRING_ARG         0x00001FA9L

//
// MessageId: FUNCTION_TRIM_OP_ARG
//
// MessageText:
//
//  Trim indicator (BOTH, LEADING, TRAILING)
//
#define FUNCTION_TRIM_OP_ARG             0x00001FAAL

//
// MessageId: FUNCTION_TRIM
//
// MessageText:
//
//  Trims a string expression
//
#define FUNCTION_TRIM                    0x00001FABL

//
// MessageId: FUNCTION_SOUNDEX_STRING_ARG
//
// MessageText:
//
//  String for which to identify phonetic representation
//
#define FUNCTION_SOUNDEX_STRING_ARG      0x00001FACL

//
// MessageId: FUNCTION_SOUNDEX
//
// MessageText:
//
//  Returns the phonetic representation of a string expression
//
#define FUNCTION_SOUNDEX                 0x00001FADL

//
// MessageId: FUNCTION_TRANSLATE_STRING1_ARG
//
// MessageText:
//
//  String where character replacement is executed
//
#define FUNCTION_TRANSLATE_STRING1_ARG   0x00001FAEL

//
// MessageId: FUNCTION_TRANSLATE_STRING2_ARG
//
// MessageText:
//
//  String identifying individual characters to be replaced
//
#define FUNCTION_TRANSLATE_STRING2_ARG   0x00001FAFL

//
// MessageId: FUNCTION_TRANSLATE_STRING3_ARG
//
// MessageText:
//
//  String identifying individual replacement characters
//
#define FUNCTION_TRANSLATE_STRING3_ARG   0x00001FB0L

//
// MessageId: FUNCTION_TRANSLATE_FROM_ARG_LIT
//
// MessageText:
//
//  from-characterset
//
#define FUNCTION_TRANSLATE_FROM_ARG_LIT  0x00001FB1L

//
// MessageId: FUNCTION_TRANSLATE_TO_ARG_LIT
//
// MessageText:
//
//  to-characterset
//
#define FUNCTION_TRANSLATE_TO_ARG_LIT    0x00001FB2L

//
// MessageId: FUNCTION_TRANSLATE
//
// MessageText:
//
//  Replaces a set of individual characters in a string with replacements
//
#define FUNCTION_TRANSLATE               0x00001FB3L

//
// MessageId: FUNCTION_MEDIAN
//
// MessageText:
//
//  Represents an inverse distribution function with a continuous distribution model
//
#define FUNCTION_MEDIAN                  0x00001FB4L

//
// MessageId: FUNCTION_STDDEV
//
// MessageText:
//
//  Returns the sample standard deviation of a numeric expression
//
#define FUNCTION_STDDEV                  0x00001FB5L

//
// MessageId: FUNCTION_ADDMONTHS_MONTH_ARG
//
// MessageText:
//
//  Number of months to be added
//
#define FUNCTION_ADDMONTHS_MONTH_ARG     0x00001FB6L

//
// MessageId: FUNCTION_ADDMONTHS
//
// MessageText:
//
//  Adds a specified number of months to a date
//
#define FUNCTION_ADDMONTHS               0x00001FB7L

//
// MessageId: FUNCTION_CURRENTDATE
//
// MessageText:
//
//  Returns the current date
//
#define FUNCTION_CURRENTDATE             0x00001FB8L

//
// MessageId: FUNCTION_EXTRACT_OP_ARG
//
// MessageText:
//
...
//
// MessageId: FUNCTION_EXTRACT_DATE_ARG
//
// MessageText:
//
//  The date/time from which to extract a portion from
//
#define FUNCTION_EXTRACT_DATE_ARG        0x00001FBAL

//
// MessageId: FUNCTION_EXTRACT_OP_ARG_LIT
//
// MessageText:
//
//  part of the date
//
#define FUNCTION_EXTRACT_OP_ARG_LIT      0x00001FBBL

//
// MessageId: FUNCTION_EXTRACT_DT_ARG_LIT
//
// MessageText:
//
//  from date
//
#define FUNCTION_EXTRACT_DT_ARG_LIT      0x00001FBCL
...
//
#define FUNCTION_EXTRACT                 0x00001FBDL

//
// MessageId: FUNCTION_DATE1_ARG_LIT
//
// MessageText:
//
//  date1
//
#define FUNCTION_DATE1_ARG_LIT           0x00001FBEL

//
// MessageId: FUNCTION_DATE2_ARG_LIT
//
// MessageText:
//
//  date2
//
#define FUNCTION_DATE2_ARG_LIT           0x00001FBFL

//
// MessageId: FUNCTION_MONTHSBETWEEN
//
// MessageText:
//
//  Returns the number of months between two dates
//
#define FUNCTION_MONTHSBETWEEN           0x00001FC0L

//
// MessageId: FUNCTION_NULLVALUE
//
// MessageText:
//
//  Returns the first argument if not NULL, the second otherwise
//
#define FUNCTION_NULLVALUE               0x00001FC1L

//
// MessageId: FUNCTION_GENERAL_FORMAT_ARG
//
// MessageText:
//
//  Format specification
//
#define FUNCTION_GENERAL_FORMAT_ARG      0x00001FC2L

//
// MessageId: FUNCTION_FORMAT_ARG_LIT
//
// MessageText:
//
//  optional format
//
#define FUNCTION_FORMAT_ARG_LIT          0x00001FC3L

//
// MessageId: FUNCTION_TODATE
//
// MessageText:
//
//  Converts a string to a date
//
#define FUNCTION_TODATE                  0x00001FC4L

//
// MessageId: FUNCTION_TODOUBLE
//
// MessageText:
//
//  Converts a string or number to a double
//
#define FUNCTION_TODOUBLE                0x00001FC5L

//
// MessageId: FUNCTION_TOFLOAT
//
// MessageText:
//
//  Converts a string or number to a float
//
#define FUNCTION_TOFLOAT                 0x00001FC6L

//
// MessageId: FUNCTION_TOINT32
//
// MessageText:
//
//  Converts a string or number to an int32
//
#define FUNCTION_TOINT32                 0x00001FC7L

//
// MessageId: FUNCTION_TOINT64
//
// MessageText:
//
//  Converts a string or number to an int64
//
#define FUNCTION_TOINT64                 0x00001FC8L

//
// MessageId: FUNCTION_TOSTRING
//
// MessageText:
//
//  Converts a number or date to a string
//
#define FUNCTION_TOSTRING                0x00001FC9L

//
// MessageId: MONTH_NAME_JANUARY
//
// MessageText:
//
//  January
//
#define MONTH_NAME_JANUARY               0x00001FCAL

//
// MessageId: MONTH_NAME_FEBRUARY
//
// MessageText:
//
//  February
//
#define MONTH_NAME_FEBRUARY              0x00001FCBL

//
// MessageId: MONTH_NAME_MARCH
//
// MessageText:
//
//  March
//
#define MONTH_NAME_MARCH                 0x00001FCCL

//
// MessageId: MONTH_NAME_APRIL
//
// MessageText:
//
//  April
//
#define MONTH_NAME_APRIL                 0x00001FCDL

//
// MessageId: MONTH_NAME_MAY
//
// MessageText:
//
//  May
//
#define MONTH_NAME_MAY                   0x00001FCEL

//
// MessageId: MONTH_NAME_JUNE
//
// MessageText:
//
//  June
//
#define MONTH_NAME_JUNE                  0x00001FCFL

//
// MessageId: MONTH_NAME_JULY
//
// MessageText:
//
//  July
//
#define MONTH_NAME_JULY                  0x00001FD0L

//
// MessageId: MONTH_NAME_AUGUST
//
// MessageText:
//
//  August
//
#define MONTH_NAME_AUGUST                0x00001FD1L

//
// MessageId: MONTH_NAME_SEPTEMBER
//
// MessageText:
//
//  September
//
#define MONTH_NAME_SEPTEMBER             0x00001FD2L

//
// MessageId: MONTH_NAME_OCTOBER
//
// MessageText:
//
//  October
//
#define MONTH_NAME_OCTOBER               0x00001FD3L

//
// MessageId: MONTH_NAME_NOVEMBER
//
// MessageText:
//
//  November
//
#define MONTH_NAME_NOVEMBER              0x00001FD4L

//
// MessageId: MONTH_NAME_DECEMBER
//
// MessageText:
//
//  December
//
#define MONTH_NAME_DECEMBER              0x00001FD5L

//
// MessageId: MONTH_ABB_JANUARY
//
// MessageText:
//
//  Jan
//
#define MONTH_ABB_JANUARY                0x00001FD6L

//
// MessageId: MONTH_ABB_FEBRUARY
//
// MessageText:
//
//  Feb
//
#define MONTH_ABB_FEBRUARY               0x00001FD7L

//
// MessageId: MONTH_ABB_MARCH
//
// MessageText:
//
//  Mar
//
#define MONTH_ABB_MARCH                  0x00001FD8L

//
// MessageId: MONTH_ABB_APRIL
//
// MessageText:
//
//  Apr
//
#define MONTH_ABB_APRIL                  0x00001FD9L

//
// MessageId: MONTH_ABB_MAY
//
// MessageText:
//
//  May
//
#define MONTH_ABB_MAY                    0x00001FDAL

//
// MessageId: MONTH_ABB_JUNE
//
// MessageText:
//
//  Jun
//
#define MONTH_ABB_JUNE                   0x00001FDBL

//
// MessageId: MONTH_ABB_JULY
//
// MessageText:
//
//  Jul
//
#define MONTH_ABB_JULY                   0x00001FDCL

//
// MessageId: MONTH_ABB_AUGUST
//
// MessageText:
//
//  Aug
//
#define MONTH_ABB_AUGUST                 0x00001FDDL

//
// MessageId: MONTH_ABB_SEPTEMBER
//
// MessageText:
//
//  Sep
//
#define MONTH_ABB_SEPTEMBER              0x00001FDEL

//
// MessageId: MONTH_ABB_OCTOBER
//
// MessageText:
//
//  Oct
//
#define MONTH_ABB_OCTOBER                0x00001FDFL

//
// MessageId: MONTH_ABB_NOVEMBER
//
// MessageText:
//
//  Nov
//
#define MONTH_ABB_NOVEMBER               0x00001FE0L

//
// MessageId: MONTH_ABB_DECEMBER
//
// MessageText:
//
//  Dec
//
#define MONTH_ABB_DECEMBER               0x00001FE1L

//
// MessageId: DAY_NAME_SUNDAY
//
// MessageText:
//
//  Sunday
//
#define DAY_NAME_SUNDAY                  0x00001FE2L

//
// MessageId: DAY_NAME_MONDAY
//
// MessageText:
//
//  Monday
//
#define DAY_NAME_MONDAY                  0x00001FE3L

//
// MessageId: DAY_NAME_TUESDAY
//
// MessageText:
//
//  Tuesday
//
#define DAY_NAME_TUESDAY                 0x00001FE4L

//
// MessageId: DAY_NAME_WEDNESDAY
//
// MessageText:
//
//  Wednesday
//
#define DAY_NAME_WEDNESDAY               0x00001FE5L

//
// MessageId: DAY_NAME_THURSDAY
//
// MessageText:
//
//  Thursday
//
#define DAY_NAME_THURSDAY                0x00001FE6L

//
// MessageId: DAY_NAME_FRIDAY
//
// MessageText:
//
//  Friday
//
#define DAY_NAME_FRIDAY                  0x00001FE7L

//
// MessageId: DAY_NAME_SATURDAY
//
// MessageText:
//
//  Saturday
//
#define DAY_NAME_SATURDAY                0x00001FE8L

//
// MessageId: DAY_ABB_SUNDAY
//
// MessageText:
//
//  Sun
//
#define DAY_ABB_SUNDAY                   0x00001FE9L

//
// MessageId: DAY_ABB_MONDAY
//
// MessageText:
//
//  Mon
//
#define DAY_ABB_MONDAY                   0x00001FEAL

//
// MessageId: DAY_ABB_TUESDAY
//
// MessageText:
//
//  Tue
//
#define DAY_ABB_TUESDAY                  0x00001FEBL

//
// MessageId: DAY_ABB_WEDNESDAY
//
// MessageText:
//
//  Wed
//
#define DAY_ABB_WEDNESDAY                0x00001FECL

//
// MessageId: DAY_ABB_THURSDAY
//
// MessageText:
//
//  Thu
//
#define DAY_ABB_THURSDAY                 0x00001FEDL

//
// MessageId: DAY_ABB_FRIDAY
//
// MessageText:
//
//  Fri
//
#define DAY_ABB_FRIDAY                   0x00001FEEL

//
// MessageId: DAY_ABB_SATURDAY
//
// MessageText:
//
//  Sat
//
#define DAY_ABB_SATURDAY                 0x00001FEFL

//
// MessageId: FUNCTION_AREA2D
//
// MessageText:
//
//  Determines the area of a given geometry
//
#define FUNCTION_AREA2D                  0x00001FF0L

//
// MessageId: FUNCTION_LENGTH2D
//
// MessageText:
//
//  Determines the length of a given geometry
//
#define FUNCTION_LENGTH2D                0x00001FF1L
